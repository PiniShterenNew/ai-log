...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-white group/calendar p-3 [--cell-size:2rem] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent dark:bg-slate-950",
      ...
      classNames={{
        root: cn("w-full min-w-[280px]", defaultClassNames.root),
        months: cn(
